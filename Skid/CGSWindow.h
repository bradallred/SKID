...
extern CGError CGSGetWindowTags(const CGSConnectionID cid, const CGSWindowID wid, CGSWindowTag *tags, int thirtyTwo);
extern CGError CGSSetWindowTags(const CGSConnectionID cid, const CGSWindowID wid, CGSWindowTag *tags, int thirtyTwo);
extern CGError CGSClearWindowTags(const CGSConnectionID cid, const CGSWindowID wid, CGSWindowTag *tags, int thirtyTwo);
extern CGError CGSGetWindowEventMask(const CGSConnectionID cid, const CGSWindowID wid, uint32_t *mask);
extern CGError CGSSetWindowEventMask(const CGSConnectionID cid, const CGSWindowID wid, uint32_t mask);
